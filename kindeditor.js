...
K.options = {
    ...
    indentChar: '\t',
    cssPath: [
        K.basePath + 'plugins/code/prettify.css'
    ],
    cssData: '',
    minWidth: 650,
    minHeight: 100,
    ...
    items: [
        ...
        'video', 'insertfile', 'table', 'hr', 'emoticons', 'baidumap', 'pagebreak',
        'anchor', 'link', 'unlink'
    ],
    ...
    htmlTags: {
        ...
        video: ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'controls', '.width', '.height', 'align', 'playsinline','webkit-playsinline','x5-playsinline','x-webkit-airplay','allowfullscreen'],
        ...
        iframe: ['id', 'class', 'src', 'frameborder', 'width', 'height', '.width', '.height','playsinline','webkit-playsinline','x5-playsinline','x-webkit-airplay','allowfullscreen'],
    },
...
function _mediaVideo(attrs) {
	...
	html += '></video>';
	return '<div class="ke-video">'+html+'</div>';
}
...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function bindEvent(el, result, data, createFunc) {
			...
			var dirPath = encodeURIComponent(result.current_dir_path + data.filename + '/');
			if (data.is_dir) {
				el.click(function(e) {
